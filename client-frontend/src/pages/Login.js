      ...
      <div className="login_container">
        <div className="login_form_container">
          ...
          <div className="input_wrapper">
            <input type="email" placeholder="Email" className="login_input"></input>
            <input type="password" placeholder="Password" className="login_input"></input>
          </div>
          <button className="login_btn">Sign in</button>
          <p className="signup_link_para">
            Don't have an account? <span className="signup_link" onClick={()=>navigate('/register')}>Sign Up</span>
          </p>
        </div>
